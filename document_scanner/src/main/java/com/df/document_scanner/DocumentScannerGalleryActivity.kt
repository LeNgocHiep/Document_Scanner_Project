 ...
 */
class DocumentScannerGalleryActivity : AppCompatActivity() {
    /**
    ...
    /**
     * @property documentScannerGallery the document scanner
     */


    private var documentScannerGallery: DocumentScannerGallery? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        documentScannerGallery = DocumentScannerGallery(
            this,
    ...
    private fun initializeUI() {
        ...
        cropRotateButton.setOnClickListener {
            documentScannerGallery?.letUserAdjustCrop(true)
            documentScannerGallery?.start(listImageOriginal[selectedPosition])//listImageOriginal[selectedPosition]
        }
        ...
        addButton.setOnClickListener {
            documentScannerGallery?.setCurrentNumDocuments(listImageCropped.size)
            documentScannerGallery?.letUserAdjustCrop(false)
            documentScannerGallery?.start()
        }
    }
...
//        Toast.makeText(this, "Image clicked: $selectedImage", Toast.LENGTH_SHORT).show()
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == Activity.RESULT_CANCELED) {
            ...
            documentScannerGallery?.onActivityResult(requestCode, resultCode, data)
        }
    }
